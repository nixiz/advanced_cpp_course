...
namespace traits
{
  ...
  namespace problem {
    ...
    // ana problem, number_of_draws() ekledi�imizde bunu crtp ile nas�l yapabiliriz ve 
    // her derive edilen tip i�in number_of_draws de�erini nas�l tek kerede hesaplayabiliriz.
    // mesela Circle c instance'� daha toplam hesaplanmadan destruct olsayd� nas�l hesaplayacakt�k??
    void usage()
    {
      Line l;
      Circle c;
